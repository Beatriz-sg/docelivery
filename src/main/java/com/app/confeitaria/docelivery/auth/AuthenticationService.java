...
import com.app.confeitaria.docelivery.exceptions.BadRequest;
import com.app.confeitaria.docelivery.exceptions.Unauthorized;
...
import com.app.confeitaria.docelivery.security.token.Token;
import com.app.confeitaria.docelivery.security.token.TokenRepository;
import com.app.confeitaria.docelivery.security.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        try {
            ...
            Class<?> clazz = Class.forName("com.app.confeitaria.docelivery.model.entity" + nomeClasse); // Obtém a classe
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) throws Unauthorized {
        try {
